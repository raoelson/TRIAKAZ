...
/**
 * Created by RAOELSON on 08/08/16.
 *
 */
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleDataMessage(JSONObject json) {
       ...
       /*     Log.e(TAG, "title 11111 : " + title);
            ...
            notifications.setImage(imageUrl);
            notifications.setEtat(0);
            notifications.setUrl(url);
            Services services = new Services(this);
            services.addNotification(notifications);
            int badgeCount = 0;
            try {
                badgeCount = (services.getCountNotification());
            } catch (NumberFormatException e) {

            }

            Log.d("test", " compteur " + badgeCount);
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                // app is in foreground, broadcast the push message
                Intent pushNotification = new Intent(Config.PUSH_NOTIFICATION);
                pushNotification.putExtra("message", message);
