...
public class ProductAdaptersGridView extends RecyclerView.Adapter<ProductAdaptersGridView.ViewHolder> {
    ...
    public ProductAdaptersGridView(Context context, List<Product> products, String mactive) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_girdview, parent, false);
